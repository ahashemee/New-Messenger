...
class RegisterViewController: UIViewController {
    ...
    // This function which is called in the button above which allows the user to be prompted to the RegisterViewController, allowing them to Create an Account.
